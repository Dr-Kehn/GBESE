...
export default function KYCPage() {
  const tiers = [
    ...
    },
    {
      ...
      route: '/account/security/kyc/tier-2',
    },
    {
      title: 'Tier 3',
      isCurrent: false,
      values: ['₦5,000,000.00', 'Unlimited', 'Unlimited'],
      route: '/account/security/kyc/tier-3',
    },
  ]
  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen text-[#2C2C2C]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 sm:py-10">
        {/* Back Button */}
        <Link href="/account/security" className="flex items-center space-x-2 mb-6 text-sm text-black hover:underline">
            ...
            >
              ...
              {tier.isCurrent ? (
                ...
                <Link href={tier.route!}>
                  <button className="bg-[#0D60D8] text-white text-sm px-4 py-2 rounded-md hover:bg-[#1E4FC3] transition">
                    Upgrade
                  </button>
                </Link>
              )}
