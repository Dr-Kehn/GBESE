...
export default function AccountPage() {
  ...
  const accountOptions = [
    { href: '/account/profile', icon: 'user.svg', label: 'View Profile' },
    { href: '/account/reports', icon: 'statement.svg', label: 'Statement & Reports' },
    { href: '/account/security', icon: 'security.svg', label: 'Security' },
    { href: '/account/saved-cards', icon: 'card.svg', label: 'Saved Cards' },
    { href: '/account/faqs', icon: 'faq.svg', label: 'FAQs' },
    { href: '/account/legal', icon: 'legal.svg', label: 'Legal' },
    { href: '/account/credit-score', icon: 'credit-score.svg', label: 'Gbese Credit Scores' },
    { href: '/account/help', icon: 'help.svg', label: 'Get Help' },
  ];
