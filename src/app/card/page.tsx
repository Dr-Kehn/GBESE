  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-start px-4 py-10 text-center">
        <h1 className="text-4xl font-bold text-blue-600 mb-6">Cards</h1>
        ...
        <div className="space-y-4 w-full max-w-md text-left">
          <Card className="flex items-center justify-between px-4 py-3 cursor-pointer hover:shadow-md transition">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">We will send it to you wherever you are</p>
              </div>
            </div>
