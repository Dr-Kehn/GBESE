...
import { useLazyGetCurrentUserQuery, IUserResponse } from "@/redux/services/slices/UserSlice";
...
export default function AccountPage() {
  ...
  const accountOptions = [
    { href: '/lenders/account/profile', icon: 'user.svg', label: 'View Profile' },
    { href: '/lenders/account/reports', icon: 'statement.svg', label: 'Statement & Reports' },
    { href: '/lenders/account/security', icon: 'security.svg', label: 'Security' },
    { href: '/lenders/account/saved-cards', icon: 'card.svg', label: 'Saved Cards' },
    { href: '/lenders/account/faqs', icon: 'faq.svg', label: 'FAQs' },
    { href: '/lenders/account/legal', icon: 'legal.svg', label: 'Legal' },
    { href: '/lenders/account/credit-score', icon: 'credit-score.svg', label: 'Gbese Credit Scores' },
    { href: '/lenders/account/help', icon: 'help.svg', label: 'Get Help' },
  ];
    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="flex justify-center items-center gap-4 mb-8">
        ...
        <div>
          ...
          <div className="flex flex-col pt-2 text-sm text-gray-500 gap-3">
